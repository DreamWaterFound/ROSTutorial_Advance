...
public:
    ...
    void Run(void) override
    {
        ...
        
        {
            ...
            {
            	ROS_INFO("Waiting For Gazebo Service Valid.");
                ros::Duration(0.1).sleep();
            }
            ...
            ROS_INFO("Init Point position:\n%lf\n%lf\n%lf",mSrvGzbModelState.response.pose.position.x,mSrvGzbModelState.response.pose.position.y,mSrvGzbModelState.response.pose.position.z );
            ROS_INFO("Init Qua orientaion:\n%lf\n%lf\n%lf\n%lf",mSrvGzbModelState.response.pose.orientation.x,mSrvGzbModelState.response.pose.orientation.y,mSrvGzbModelState.response.pose.orientation.z, mSrvGzbModelState.response.pose.orientation.w);
        }
        ...
        // Step 2 设置机器人的初始位姿
        {
            ...
            {
            	ROS_INFO("Waiting Init Topic to  get Subscribed.");
                ros::Duration(0.1).sleep();
            }
